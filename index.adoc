...
[source, diff]
----
+ Can add Leagues, Teams, Players, Scores, and Games
+ Can generate points on games
+ Can show Player, Team, and League statistics in nice tables
- Cannot generate games for a season based on availability
- Cannot automatically add blind scores
- Minimal authentication administration options
----
